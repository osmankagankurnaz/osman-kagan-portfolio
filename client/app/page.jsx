  ...
  return (
      <Box  display={"flex"}  justifyContent={"center"} alignItems={"center"} px={{base:15,md:0}} overflowY={"auto"} flexDir={{base:"column-reverse",md:"row"}} gap={{base:"2rem",md:"4rem"}}>
        <Box  maxW={{base:"90%",md:"auto"}} >
          ...
          <Text fontSize={{base:"3.5rem",md:"6rem"}} fontWeight={"bold"} textColor={"white"} lineHeight={"6rem"} mb={{md:"1rem"}}>I’m <span style={{ background: "-webkit-linear-gradient(135deg,#FC41D3 0%, #A047FA 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Developer</span><br />& <span style={{ background: "-webkit-linear-gradient(135deg,#F13131 0%, #FA974F 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>UI Designer</span></Text>
          <Text textColor={"white"} fontSize={"1.25rem"} fontWeight={"normal"} mt={"1rem"} w={{base:"20rem",md:"32.5rem"}} mb={"2rem"}>I am a 3rd year Computer Engineering student at Selcuk University. I do studies and research on the web.</Text>
          <Box display={"flex"} flexDir={"row"} gap={{base:"2rem",md:"1rem"}} mb={{md:"3rem"}} flexWrap={"wrap"}>
        ...
        <Box overflow={"hidden"} display={{base:"flex",md:"none"}} position={"relative"} mt={"2rem"} rounded={"full"} w={{base:"15rem",md:"28rem"}} h={{base:"15rem",md:"42rem"}} border={"2px solid"} borderColor={"white"}  >
         
          <Image src={"/profile2.png"} fill/> 
      </Box>
      <Box overflow={"hidden"} display={{base:"none",md:"flex"}} position={"relative"} mt={"2rem"} rounded={"full"} w={{base:"15rem",md:"28rem"}} h={{base:"15rem",md:"42rem"}} border={"2px solid"} borderColor={"white"}  >
